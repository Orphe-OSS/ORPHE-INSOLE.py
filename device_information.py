...
async def main():
    ...
    # 最初の状態を取得
    print("Initial state:")
    # print(orphe.device_information.data)
    await orphe.print_device_information()

    # 設定できる項目
    # await orphe.set_mount_position(1)  # 0: Left, 1: Right
    # await orphe.set_acc_range(16)  # 2, 4, 8, 16で設定
    # await orphe.set_gyro_range(2000)  # 250, 500, 1000, 2000で設定
